...
/*   Updated: 2023/05/25 13:24:47 by tnam             ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void	ft_exit_builtin(t_list *mini_envp, t_parse *parse, t_exec *exec);
void	ft_export_builtin(t_info *info, t_exec_info *exec_info);
int		ft_pwd_builtin(void);
void	ft_unset_builtin(t_info *info, t_exec_info *exec_info);
